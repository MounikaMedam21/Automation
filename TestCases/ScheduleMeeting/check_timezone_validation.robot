...
Verify user able to navigate to the scheduling page
    ...
    sleep   3s
Verify that should display a valiadtion message for time zone field
    Check the validation message for the time zone field    Creating    Good Morning      https://google.com