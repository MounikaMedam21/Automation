...
Verify user able to navigate to the scheduling page
    ...
    sleep   3s
Verify that should display a validation messages for empty fields
    Check the validations in the create new schedule dashboard page
Verify that should display a valiadtion message for meeting name field
    Check the validation message for the meeting name field     Good Morning      https://google.com
