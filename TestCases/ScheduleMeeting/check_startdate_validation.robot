...
Verify user able to navigate to the scheduling page
    ...
    sleep   3s
Verify that should display a valiadtion message for start date field
    Check the validation message for the start date field     Creating    Good Morning      https://google.com